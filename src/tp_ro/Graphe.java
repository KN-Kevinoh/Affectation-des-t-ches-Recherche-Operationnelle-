...
public class Graphe {
	...
	/*
	 * Dans la classe Graphe, Ã©crire une mÃ©thode
		public LinkedList<Noeud> cheminBFS(Noeud s, Noeud t)
		qui cherche un plus court chemin (en nombre dâ€™arc) du nÅ“ud s au nÅ“ud t. La
		mÃ©thode renvoi null si un tel chemin nâ€™existe pas.
	 */
...
public boolean inverseChemin(LinkedList<Noeud> chemin) {
	 ...
	 while(!queue.isEmpty()) {
		 ...
		 for(Noeud id : index(p)) {
			 ...
			 /*
			  * La mÃ©thode renvoi true si lâ€™oprÃ©ration complÃ¨te
                avec succÃ¨s, false sâ€™il y a un arc du chemin qui nâ€™appartient pas au graphe.
			  */
 ...
 *  Dans la classe Graphe, Ã©crire une mÃ©thode public int ff(Noeud s, Noeud t)
	qui execute une version de lâ€™algorithme Ford
 */
